export function buildListOptions(query, { allowedSorts = [], exactFilters = [], searchFields = [], buildCustomFilters = null } = {}) {
  ...
  if (buildCustomFilters) {
    Object.assign(filters, buildCustomFilters(query, filters) || {});
  }
