...
export const EMAIL_TEMPLATE_DEFINITIONS = [
  ...
  { key: EMAIL_TEMPLATE_KEYS.CONTACT_ADMIN_NOTIFICATION, name: "Contact Us Admin Notification", module: "Contact", type: "contact", trigger: "Website Contact Us form is submitted", variables: ["contact_name", "contact_email", "contact_interest", "contact_message", "contact_submitted_at", "admin_email", "company_name", "support_email"] },
  { key: EMAIL_TEMPLATE_KEYS.CONTACT_REPLY, name: "Contact Us Reply", module: "Contact", type: "contact", trigger: "Admin replies to a website contact message", variables: ["user_name", "email", "contact_name", "contact_email", "contact_interest", "contact_message", "contact_submitted_at", "admin_reply", "company_name", "support_email"] },
...
<p>Thank you for contacting support.</p>`,
  ...
  [EMAIL_TEMPLATE_KEYS.CONTACT_ADMIN_NOTIFICATION]: {
    subject: "New Contact Us Inquiry from {{contact_name}}",
    text: "New Contact Us Inquiry\n\nName: {{contact_name}}\nEmail: {{contact_email}}\nInterested In: {{contact_interest}}\nSubmitted: {{contact_submitted_at}}\n\nMessage:\n{{contact_message}}",
    html: `<div style="font-family:Arial,Helvetica,sans-serif;color:#111827;font-size:14px;line-height:1.6;">
<h2 style="margin:0 0 16px;">New Contact Us Inquiry</h2>
<p><strong>Name:</strong> {{contact_name}}</p>
<p><strong>Email:</strong> {{contact_email}}</p>
<p><strong>Interested In:</strong> {{contact_interest}}</p>
<p><strong>Submitted:</strong> {{contact_submitted_at}}</p>
<p><strong>Message:</strong></p>
<div style="white-space:pre-wrap;border-left:4px solid #2563eb;padding-left:12px;">{{contact_message}}</div>
</div>`,
  },
  [EMAIL_TEMPLATE_KEYS.CONTACT_REPLY]: {
    subject: "Re: Your inquiry to {{company_name}}",
    text: "Hi {{contact_name}},\n\nAdmin reply:\n{{admin_reply}}\n\nYour original message:\nName: {{contact_name}}\nEmail: {{contact_email}}\nInterested In: {{contact_interest}}\nSubmitted: {{contact_submitted_at}}\n\n{{contact_message}}\n\nRegards,\n{{company_name}} Support Team",
    html: `<div style="font-family:Arial,Helvetica,sans-serif;color:#0f172a;font-size:14px;line-height:1.6;">
<h2 style="margin:0 0 12px;">Reply from {{company_name}}</h2>
<p>Hi {{contact_name}},</p>
...
<div style="white-space:pre-wrap;">{{admin_reply}}</div>
</div>
...
<p><strong>Interested In:</strong> {{contact_interest}}</p>
<p><strong>Submitted:</strong> {{contact_submitted_at}}</p>
<div style="white-space:pre-wrap;">{{contact_message}}</div>
</div>
<p style="margin-top:22px;color:#64748b;">Regards,<br/>{{company_name}} Support Team</p>
</div>`,
  },
