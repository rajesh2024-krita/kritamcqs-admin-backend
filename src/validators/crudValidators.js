...
export const listQuerySchema = z.object({
  query: paginationQuerySchema.extend({
    ...
    examAudience: z.string().optional(),
...
export const subscriptionPlanBodySchema = z.object({
  ...
  productId: z.string().trim().max(255).optional().or(z.literal("")),
  iosProductId: z.string().trim().max(255).optional().or(z.literal("")),
  appleProductId: z.string().trim().max(255).optional().or(z.literal("")),
  storeProductId: z.string().trim().max(255).optional().or(z.literal("")),
